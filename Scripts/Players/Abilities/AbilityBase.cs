...
{
    [Header("General properties of abilities")] [SerializeField]
    protected GameObject IconAbility;
    ...
    [Header("Autoattack")] [SerializeField]
    protected GameObject IconAbilityAutoattack;
