...
public class CharacterState : NetworkBehaviour
{
	...
	public event System.Action<AbstractCharacterState> OnStateExit;
	...
	public int CheckStateStacks(States state)
	{
		foreach (AbstractCharacterState states in _currentStates)
		{
			if (states.State == state)
			{
				...
				{
					var stackableState = states as StackableState;
                    return stackableState.CurrentStacksCount;
				}
				return 0;
			}
		}
	...
	public void RemoveStateFromList(AbstractCharacterState newState)
	{
