...
public class IceRolling : Ability
{
	...
	protected override void Cancel()
	{
		...
		//вроде не было нужды дл€ отмены каста, пока что....
	}
	...
	private void Jump()
	{
		if (_canJump )
		{
			...
			{
				Debug.Log("ќбнаружено преп€тствие:");
				//прыгать до преп€тстви€
	...
	//делим на cell size что бы считалось врем€ не за одну единицу юнити, а за наши, клетки
	...
	{
		//ѕроверка на наличие преп€тстви€
