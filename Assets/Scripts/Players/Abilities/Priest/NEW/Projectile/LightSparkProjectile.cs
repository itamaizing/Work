...
public class LightSparkProjectile : Projectiles
{
    ...
    public void Init(HeroComponent dad, bool isLightMode, SparkOfLight skill, float distance, float attackDelay, Transform target)
    {
        _dad = dad;
    ...
    private void Update()
    {
        ...
        Vector3 forwardMovement = directionToTarget * (_speed * Time.deltaTime);
