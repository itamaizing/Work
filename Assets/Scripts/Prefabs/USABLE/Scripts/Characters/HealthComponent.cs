...
public class HealthComponent : NetworkBehaviour
{
    ...
    public void Initialize(float maxHealth,float regenValue,float regenDelay , StatsInfo healthInfo)
    {
    ...
    {
        GetComponent<UIComponent>().ShowPopupValue(value,startColor,endColor);
    }

    private void ShowDamagePrefab(string text, Color startColor, Color endColor) //������������ ��� �������
    {
        GetComponent<UIComponent>().ShowPopupText(text,startColor,endColor);
    }
